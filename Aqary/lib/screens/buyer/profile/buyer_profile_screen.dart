...
import '../../auth/login_screen.dart'; // افترضت أن هذا مسار شاشة تسجيل الدخول، قم بتعديله إذا لزم الأمر
...
class BuyerProfileScreen extends StatelessWidget {
    ...
    return Center(
      child: Column(
        children: [
          ...
          SizedBox(
            width: 180, // تحديد عرض ثابت لتصغير الزر
            height: 45, // تحديد ارتفاع متناسق
  ...
  // Clean and interactive list tile
