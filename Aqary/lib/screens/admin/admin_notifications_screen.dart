    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(_lastResult!), backgroundColor: AppTheme.success));
      }
    } catch (e) {
      if (mounted) {
        setState(() { _isSending = false; _lastResult = 'Failed: $e'; });
        ScaffoldMessenger.of(context).showSnackBar(
          ...
          child: Form(key: _formKey, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Wrap(spacing: 8, runSpacing: 8,
              children: [
                ...
                return GestureDetector(
                  onTap: () => setState(() => _targetRole = opt['value']!),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                prefixIcon: Padding(padding: EdgeInsets.only(bottom: 40), child: Icon(Icons.message_outlined)),
            ...
            builder: (context, snapshot) {
              ...
              if (broadcasts.isEmpty) {
                return Container(
                  ...
                  child: const Center(child: Text('No broadcasts sent yet.',
                      style: TextStyle(color: AppTheme.textMuted, fontSize: 13))));
              }

              return Column(
                children: broadcasts.map((n) => Dismissible(
                  key: ValueKey(n.id),
